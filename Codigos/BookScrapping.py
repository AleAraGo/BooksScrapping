'''
Nós queremos acessar a págida, pegar links dos livros, acessar cada link em busca da quantidade em estoque,
...
# os livros começãm no 54 e terminam no 92 sw 2 em 2
